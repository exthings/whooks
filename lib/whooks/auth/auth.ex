defmodule Whooks.Auth do
  ...
  See `Whooks.Auth.User.email_changeset/3` for a list of supported options.
  ...
  See `Whooks.Auth.User.password_changeset/3` for a list of supported options.
