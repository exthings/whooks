...
Additionally, Svix offers a [white-labeled embeddable portal](app-portal.mdx), allowing your customers to self-manage their own webhook endpoints, subscriptions, delivery rates, and more.
...
![API Access page](/img/api-access-page.webp)

### Install the Svix SDK (optional)

<Tabs items={["JavaScript","Python","Rust","Go","Java","Kotlin","Ruby","C#","PHP","CLI","cURL"]}>
