...
description: "BullMQ expert for Redis-backed job queues, background processing, and reliable async execution in Elixir applications. Use when: bullmq, bull queue, redis queue, background job, job queue."
